...
AVSC_PATH = os.environ.get("TRANSACTION_AVSC_PATH", "/app/avro_schemas/transaction_v2_pass.avsc")
SPEED_FACTOR = 3600
...
def run():
    ...
    for i, row in tx.iterrows():
        ...
        value_bytes = value_serializer(row_to_dict(row), SerializationContext(TOPIC, MessageField.VALUE))
